        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            ...
            Card(
                ...
                when (screenNum) {
                    ...
                    3 -> personScreen(screenNum = { screenNum = it },student=student,studentReturn = {student=it})
                    4 -> settingsScreen(screenNum = { screenNum = it },student=student,studentReturn = {student=it})
                    5 -> updateScreen(screenNum = { screenNum = it },student=student,studentReturn = {student=it})
